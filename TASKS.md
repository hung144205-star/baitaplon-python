...
| 🟠 **P1** | Phase 4: Warehouse Management (Kho) | ⚪ Not Started | `v0.4-kho` |
| 🟡 **P2** | Phase 5: Contract Management (Hợp đồng) | ⚪ Not Started | `v0.5-hop-dong` |
| 🟡 **P2** | Phase 6: Goods Management (Hàng hóa) | ⚪ Not Started | `v0.6-hang-hoa` |
...
- [ ] Refactor src/models/kho.py
- [ ] Tạo src/services/kho_service.py
  - [ ] create(data) → Kho
  - [ ] get_by_id(ma_kho) → Kho
  - [ ] get_all() → List[Kho]
  - [ ] search(keyword) → List[Kho]
  - [ ] update(ma_kho, data) → Kho
  - [ ] delete(ma_kho) → bool
  - [ ] calculate_fill_rate(ma_kho) → float
  - [ ] get_available_capacity(ma_kho) → float

### 4.2 Kho GUI
- [ ] Tạo src/gui/views/kho_view.py
- [ ] Danh sách kho (QTableWidget)
  - [ ] Columns: Mã, Tên, Địa chỉ, Diện tích, Sức chứa, Đã sử dụng, % Lấp đầy, Trạng thái
  - [ ] Progress bar cho % lấp đầy
- [ ] Toolbar: Thêm, Sửa, Xóa, Refresh
- [ ] Search & Filter
- [ ] Tạo src/gui/forms/kho_form.py

### 4.3 Vi Tri Models & Services
- [ ] Refactor src/models/vi_tri.py
- [ ] Tạo src/services/vi_tri_service.py
  - [ ] create(data) → ViTri
  - [ ] get_by_id(ma_vi_tri) → ViTri
  - [ ] get_by_kho(ma_kho) → List[ViTri]
  - [ ] get_available(ma_kho) → List[ViTri]
  - [ ] update(ma_vi_tri, data) → ViTri
  - [ ] delete(ma_vi_tri) → bool
  - [ ] update_status(ma_vi_tri, trang_thai) → bool

### 4.4 Vi Tri GUI
- [ ] Tạo src/gui/views/vi_tri_view.py
- [ ] Danh sách vị trí theo kho
- [ ] Visual grid layout (optional)
- [ ] Color coding by status
- [ ] Tạo src/gui/forms/vi_tri_form.py
- [ ] Auto-generate mã vị trí (K01-A-01-01 pattern)

### 4.5 Dashboard Integration
- [ ] Update dashboard với fill rate widgets
- [ ] Show warehouse status cards
- [ ] Alert khi fill rate > 90%
...
- [ ] Review `stitch_ui_analysis_system/chi_tiet_kho/`
- [ ] Review `stitch_ui_analysis_system/thong_tin_kho_hang/`

### ✅ Phase 4 Deliverables:
- [ ] CRUD Kho hoàn chỉnh
- [ ] CRUD Vị trí hoàn chỉnh
...
- [ ] generate_revenue_report(start_date, end_date) → dict
- [ ] generate_fill_rate_report() → dict
- [ ] generate_debt_report() → dict
- [ ] generate_contract_report() → dict
- [ ] generate_inventory_report() → dict
...
|-------|-------|------|----------|
| Phase 1: Database | 25 | 20 | ████████░░ 80% |
| Phase 2: Framework | 35 | 35 | ██████████ 100% |
| Phase 3: Khách hàng | 30 | 0 | ░░░░░░░░░░ 0% |
| Phase 4: Kho | 25 | 0 | ░░░░░░░░░░ 0% |
| Phase 5: Hợp đồng | 30 | 0 | ░░░░░░░░░░ 0% |
| Phase 6: Hàng hóa | 25 | 0 | ░░░░░░░░░░ 0% |
| Phase 7: Thanh toán | 25 | 0 | ░░░░░░░░░░ 0% |
| Phase 8: Báo cáo | 20 | 0 | ░░░░░░░░░░ 0% |
| Phase 9: Auth | 20 | 0 | ░░░░░░░░░░ 0% |
