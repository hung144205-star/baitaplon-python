...
### 8.2 GUI - View
- [x] Tạo src/gui/views/bao_cao_view.py
  - [x] Select report type (ComboBox) - 6 loại báo cáo
  - [x] Preview report (QTextEdit)
  - [x] Toolbar: Xuất TXT, Xuất PDF
  - [x] Report types:
    - [x] Báo cáo tổng hợp (summary)
    - [x] Báo cáo doanh thu (revenue)
    - [x] Báo cáo kho (warehouse)
    - [x] Báo cáo hợp đồng (contract)
    - [x] Báo cáo cảnh báo (alerts)
    - [x] Dashboard summary
...
- [x] Setup ReportLab dependencies (đã có trong requirements.txt)
- [x] Implement actual PDF conversion (ReportLab)
- [x] Vietnamese font support (DejaVu Sans fallback)

### 8.4 Reference UI
- [x] Review `stitch_ui_analysis_system/bao_cao_trang_thai/`

### ✅ Phase 8 Deliverables:
- [x] GUI xem báo cáo hoàn chỉnh
- [x] Multiple report types (6 loại)
- [x] PDF export (ReportLab)
- [x] TXT export
- [x] **GitHub Release v0.8-bao-cao**
